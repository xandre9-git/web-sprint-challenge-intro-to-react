...
`React JS is a front-end JavaScript library used for building User Interfaces and User Interface Components. React solves the problem of having to use Vanilla JS to select elements, classes, ids and etc in order to append it to elements manually. It introduces JSX which allows you to use HTML code inside of JS.`

1. Describe component state.

`State that is managed inside of the component.`

1. Describe props.

`Props, short for properties, is a JavaScript object argument that gets passed into components. They are read-only data.`

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

`A side effect is anything that affects data outside of its excecuted function's scope. Effects in a React component can be synced through the use of the useEffect() hook for changes in state or props.`
